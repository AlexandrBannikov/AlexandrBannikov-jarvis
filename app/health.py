...
def health_payload() -> dict[str, object]:
    payload = {
        ...
        "routing_audit_ok":bool(_ROUTING_AGENT and getattr(_ROUTING_AGENT,"routing_quality",None) and _ROUTING_AGENT.routing_quality.ok),
        "routing_holdout_score":round(float(getattr(getattr(_ROUTING_AGENT,"routing_quality",None),"score",0.0)),4),
        "current_info_recall":round(float(getattr(getattr(_ROUTING_AGENT,"routing_quality",None),"current_info_recall",0.0)),4),
        "stable_false_search_rate":round(float(getattr(getattr(_ROUTING_AGENT,"routing_quality",None),"stable_false_search_rate",0.0)),4),
        "private_search_leakage_count":int(getattr(getattr(_ROUTING_AGENT,"routing_audit",None),"private_search_leakage_count",0)),
        "external_project_write_attempts":int(getattr(getattr(_ROUTING_AGENT,"routing_audit",None),"external_project_write_attempts",0)),
        "last_routing_error_code":getattr(getattr(_ROUTING_AGENT,"routing_audit",None),"last_error_code","NONE"),
