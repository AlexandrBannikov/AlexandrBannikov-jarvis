...
class ReverseGeocoder:
    def __init__(self,endpoint="https://nominatim.openstreetmap.org/reverse",timeout=5.0,opener=urlopen): self.endpoint=endpoint; self.timeout=timeout; self.opener=opener
    def resolve(self,latitude,longitude):
